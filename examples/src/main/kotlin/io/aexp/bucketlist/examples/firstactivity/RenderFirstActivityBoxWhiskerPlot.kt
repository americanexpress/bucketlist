...
/**
 * This renders a box and whisker plot for the Time To First Activity data exported by ExportFirstActivityData.
 *
 * Usage: invoke with <exported tsv> <destination svg>
 */
object RenderFirstActivityBoxWhiskerPlot {
