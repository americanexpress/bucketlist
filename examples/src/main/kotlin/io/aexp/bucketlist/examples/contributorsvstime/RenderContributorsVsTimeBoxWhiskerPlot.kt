...
/**
 * This renders a box and whisker plot for the Contributors vs Time data exported by ExportContributorsVsTimeData.
 *
 * Usage: invoke with <exported tsv> <destination svg>
 */
object RenderContributorsVsTimeBoxWhiskerPlot {
    ...
    @JvmStatic fun main(args: Array<String>) {
        ...
        xRenderer.label = "Number of Contributors"
        ...
        boxPlot.title.text = "Contributors Vs Time";
